  ...
  var operation = function () {
    ...
    if (next) {
      next(retryRequestOptions, function (returnObject, finalCallback, nextPostCallback) {
        ...
        var secondaryNotFound = (retryRequestOptions.currentLocation === Constants.StorageLocation.SECONDARY) && ((returnObject.response && returnObject.response.statusCode === 404) || (returnObject && returnObject.error && returnObject.error.code === 'ENOTFOUND'));
